...
//    }
    ...
    public static List<TipKnjige> listTipovi(){
        ...
        TipKnjige tip2 = new TipKnjige(2,"Književnost");
        TipKnjige tip3 = new TipKnjige(3,"Književnost 23");
        TipKnjige tip4 = new TipKnjige(4,"Književnost 3");
    ...
    public static List<Autor> listAutora(){
        ...
        Autor tip2 = new Autor(2,"Književnost","Prezime");
        Autor tip3 = new Autor(3,"Književnost 23","Prezime");
        Autor tip4 = new Autor(4,"Književnost 3","Prezime");
